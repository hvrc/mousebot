...
# from pages.strains_page import StrainsPage  # Uncomment if you implement StrainsPage
...
def test_reset_colony(driver, config):
    ...
    # strains_page = StrainsPage(driver)  # Uncomment if you implement StrainsPage
